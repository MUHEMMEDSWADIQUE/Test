...
This folder defines all source code for the 'pipeline 1' pipeline:
...
* Take a look at the sample under "sample_users_pipeline_1.py" to get familiar with the syntax.
